...
class Graph:
    ...
    def printSCCs(self):
        ...
        run_output_label = Label(
            app, text=scc_output, font=("times", 18, "bold"), fg="white", bg="black"
        )
    ...
    def give_a_random_friend(self):
        ...
        rf_output_label = Label(
            app, text=output, font=("times", 18, "bold"), fg="white", bg="black"
        )
...
if __name__ == "__main__":
    ...
    # Title label
    title_label = Label(
        app, text="Connecting Friends", font=("Times", 45), fg="white", bg="black"
    )
    ...
    txt_label = Label(
        app,
        text="Enter the name of person  here ",
        font=("times", 24, "bold"),
        fg="white",
        bg="black",
    )
    ...
    random_friend_button = Button(
        text="Get a friend",
        command=sub.give_a_random_friend,
        bg="black",
        fg="white",
        activebackground="white",
        activeforeground="black",
    ...
    txt_label_2 = Label(
        app,
        text="Enter the name of people  here",
        font=("times", 24, "bold"),
        fg="white",
        bg="black",
    )
    ...
    mutual_friend_button = Button(
        text="Get Mutual friend",
        command=sub.get_mutual_friend,
        bg="black",
        fg="white",
        activebackground="white",
        activeforeground="black",
